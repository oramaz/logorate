        ...
        <div className="logo-page-info" style={{ marginBottom: "100px" }}>
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <div>
              ...
              <div>
                <div
                  className="text-center content-text-small"
                  style={{ margin: "30px 0" }}
                >
                  or
                </div>
                <div className=" text-center  content-text-small">
                  ...
                  and download logo in SVG for free
                </div>
              </div>
            </div>
          </div>
