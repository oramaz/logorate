          ...
          <div className="profile-data-side">
            ...
            <div style={{ marginBottom: "100px" }}>
              ...
              <div className="d-inline-block">
                <div style={{ marginBottom: "30px" }}>
                  <b style={{ marginRight: "20px" }}>Current status:</b>
                  <span className="gradient-text">Monthly subscription</span>
                </div>
                <div className="text-center">
                  <div className="content-btn-border-container  gradient-border d-inline-block">
                    <button
                      type="button"
                      className="content-btn-border-sm  gradient-border mx-auto"
            ...
            <div style={{ marginBottom: "50px" }}>
              ...
              <div className="d-inline-block">
                <div style={{ marginBottom: "30px" }}>
                  <b style={{ marginRight: "20px" }}>Current status:</b>
                  <span className="gradient-text">Autopay on</span>
                </div>
                <div className="text-center">
                  <button
                    type="button"
                    className="content-btn-sm mx-auto"
